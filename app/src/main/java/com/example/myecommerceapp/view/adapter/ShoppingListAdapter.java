...
package com.example.myecommerceapp.view.adapter;
...
import com.example.myecommerceapp.view.customview.ItemTouchHelperViewHolder;
import com.example.myecommerceapp.view.customview.OnStartDragListener;
import com.example.myecommerceapp.view.customview.TextDrawable;
import com.example.myecommerceapp.view.fragment.MyCartFragment;
...
public class ShoppingListAdapter extends
    ...
    public void onBindViewHolder(final ItemViewHolder holder, final int position) {
        ...
        String sellCostString = Money.rupees(
                BigDecimal.valueOf(Long.parseLong(productList.get(position)
                        .getSellMRP()))).toString()
                + "  ";
