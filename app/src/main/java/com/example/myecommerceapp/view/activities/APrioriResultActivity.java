...
import com.example.myecommerceapp.util.Animatrix;
...
public abstract class APrioriResultActivity extends AppCompatActivity implements OnChartValueSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        barChart = findViewById(R.id.apriori_data);
