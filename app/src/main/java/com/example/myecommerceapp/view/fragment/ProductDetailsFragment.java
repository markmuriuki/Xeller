...
import com.example.myecommerceapp.model.CenterRepository;
import com.example.myecommerceapp.model.entities.Money;
import com.example.myecommerceapp.model.entities.Product;
import com.example.myecommerceapp.util.ColorGenerator;
import com.example.myecommerceapp.util.Utils;
import com.example.myecommerceapp.view.activities.ECartHomeActivity;
import com.example.myecommerceapp.view.adapter.SimilarProductsPagerAdapter;
import com.example.myecommerceapp.view.customview.ClickableViewPager;
//import com.example.myecommerceapp.view.customview.ClickableViewPager.OnItemClickListener;
import com.example.myecommerceapp.view.customview.LabelView;
import com.example.myecommerceapp.view.customview.TextDrawable;
...
public class ProductDetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mToolbar != null) {
            ((ECartHomeActivity) Objects.requireNonNull(getActivity())).setSupportActionBar(mToolbar);
        }
        ...
        Objects.requireNonNull(((ECartHomeActivity) Objects.requireNonNull(getActivity())).getSupportActionBar())
                .setDisplayHomeAsUpEnabled(true);
                        ...
                        if (isFromCart) {
                            ...
                            if (CenterRepository.getCenterRepository()
                                ...
                                if (Integer.parseInt(tempObj.getQuantity()) == 0) {
                                    ...
                                    ((ECartHomeActivity) Objects.requireNonNull(getContext()))
                                ...
                                ((ECartHomeActivity) Objects.requireNonNull(getContext())).updateCheckOutAmount(
                                        BigDecimal.valueOf(Long
                                                .parseLong(Objects.requireNonNull(CenterRepository
                                                        .getCenterRepository()
                ...
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
...

                        {
                            ...
                            if (Integer.parseInt(CenterRepository
                                    .getCenterRepository().getListOfProductsInShoppingList()
                                ...
                                Utils.vibrate(getActivity());
                            } else if (Integer.parseInt(CenterRepository
                                    .getCenterRepository().getListOfProductsInShoppingList()
                            ...
                            Product tempObj = Objects.requireNonNull(CenterRepository
                                    .getCenterRepository().getMapOfProductsInCategory()
                                    .get(subcategoryKey)).get(productListNumber);
    ...
    private void showRecomondation() {
        ...
        topSellingPager.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                Utils.vibrate(Objects.requireNonNull(getActivity()));
    ...
    public void fillProductData() {
        ...
        if (!isFromCart) {
            ...
            //Fetch and display item from Global Data Model
            ...
            String sellCostString = Money.rupees(
                    BigDecimal.valueOf(Long.parseLong(CenterRepository
                            .getCenterRepository().getMapOfProductsInCategory()
                            .get(subcategoryKey).get(productListNumber)
                            .getSellMRP()))).toString()
                    + "  ";
            ...
            drawable = mDrawableBuilder.build(
                    String.valueOf(Objects.requireNonNull(CenterRepository.getCenterRepository()
                            .getMapOfProductsInCategory().get(subcategoryKey))
                            .get(productListNumber).getItemName().charAt(0)),
                    mColorGenerator.getColor(Objects.requireNonNull(CenterRepository
                            .getCenterRepository().getMapOfProductsInCategory()
                            .get(subcategoryKey)).get(productListNumber)
                            .getItemName()));

            Picasso.with(getActivity())
                    .load(Objects.requireNonNull(CenterRepository.getCenterRepository().getMapOfProductsInCategory()
                            .get(subcategoryKey)).get(productListNumber)
            ...
            label.setText(Objects.requireNonNull(CenterRepository.getCenterRepository().getMapOfProductsInCategory()
